...
class AnimalWallPapers extends StatefulWidget {
  const AnimalWallPapers({super.key});

  @override
  State<AnimalWallPapers> createState() => _AnimalWallPapersState();
}

class _AnimalWallPapersState extends State<AnimalWallPapers> {
  @override
    ...
    return Consumer<ApiController>(builder: (context, provider, child) {
      return Scaffold(
        ...
        body: Consumer<ApiController>(builder: (context, provider, child) {
          List Animaldata = provider.Animaldata;
          return Center(
            child: Column(
              children: [
                ...
                Expanded(
                  child: GridView.builder(
                    itemCount: provider.Animaldata.length,
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: NetworkImage(
                                Animaldata[index]['largeImageURL'],
                              ),
                              fit: BoxFit.fill,
                            ),
                          ),
